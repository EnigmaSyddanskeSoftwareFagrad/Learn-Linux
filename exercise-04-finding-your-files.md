...
2. Use the command line tool find to find all files that have the are called 'hidden-file.txt' where is a number. The files are hidden, so you'll have to use the -name option to find them.